    ...
    Widget build(BuildContext context) {
        final theme = Theme.of(context);
            ...
            final titleStyle = theme.textTheme.bodySmall?.copyWith(
                    ...
                    const TextStyle(color: Colors.black, fontSize: 13, fontWeight: FontWeight.w600);
            final valueStyle = theme.textTheme.bodySmall?.copyWith(
                        color: const Color(0xFF9A9A9A),
                        fontSize: 13,
                        fontWeight: FontWeight.w500,
                    ) ??
                    const TextStyle(color: Color(0xFF9A9A9A), fontSize: 13, fontWeight: FontWeight.w500);
                        ...
                        children: [
                            ...
                            Positioned(
                                ...
                                child: SizedBox(
                                    ...
                                    child: CircleAvatar(
                                        ...
                                        child: Icon(Icons.fitness_center, size: 14, color: theme.colorScheme.onPrimary),
                                    ),
                                ),
                            ),
                            ...
                            Positioned(
                                ...
                                child: GestureDetector(
                                    onTap: widget.onModify ?? () async {
                                        await Navigator.pushNamed(context, UserPlanPage.routeName);
                                    ...
                                    child: Container(
                                        ...
                                        child: Text('Modify',
                                            ...
                                            style: theme.textTheme.labelSmall?.copyWith(color: Colors.white, fontSize: 10, fontWeight: FontWeight.w700) ?? const TextStyle(color: Colors.white, fontSize: 10, fontWeight: FontWeight.w700)),
                                    ),
                                ),
                            ),

                            // Column labels (Reps / Set / Form Condition)
                            Positioned(left: 156, top: 12, child: Text('Reps', style: labelStyle)),
                            Positioned(left: 200, top: 12, child: Text('Set', style: labelStyle)),
                            Positioned(left: 248, top: 12, child: Text('Form', style: labelStyle)),
                            ...
                            if (_isLoading)
                                ...
                                Positioned(
                                    ...
                                    child: SizedBox(
                                        width: 120,
                                        child: Text(_error!, style: valueStyle.copyWith(color: Colors.red, fontSize: 10)),
                                    ),
                                )
                            else ...[
                                Positioned(left: 156, top: 28, child: Text('$_reps', style: valueStyle)),
                                Positioned(left: 200, top: 28, child: Text('$_sets', style: valueStyle)),
                                Positioned(left: 248, top: 28, child: Text(_formCondition, style: valueStyle.copyWith(color: const Color(0xFF94B900)))),
                            ],
                        ],
                    ),
                ),
